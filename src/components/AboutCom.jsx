...
function AboutCom() {
    ...
    return (
        <section className='w-11/12 sm:w-5/6 lg:w-4/5 max-w-screen-lg grid lg:grid-cols-2 sm:grid-cols-1 gap-y-16 md:gap-x-8 mx-auto mt-12 p-6 md:p-8'>
            ...
            <img src="about-us.webp" alt="Expert Team" className='max-w-[350px] lg:max-w-none w-[90%] rounded-[50%] m-auto' data-aos="fade-up" />
            <div className='space-y-8' data-aos="fade-up">
                ...
                <div className='space-y-5'>
                    <div className='font-sans'>
                        ...
                        <p className='text-base'>Empowering businesses with cutting-edge IT solutions. At Ethian Tech, we craft custom technology solutions to drive efficiency and innovation.</p>
                    </div>
                    <div className='font-sans'>
