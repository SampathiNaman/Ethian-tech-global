                    ...
                    <div className='space-y-8'>
                        <div className='space-y-4'>
                            <div className='flex items-center space-x-2'>
                                ...
                                <a href="tel:+14436758888" className="text-base cursor-pointer">+1-443-675-8888</a>
                            </div>
                            <div className='flex items-center space-x-2'>
                                <img src="whatsapp.png" alt="WhatsApp Icon" className='w-6' />
                                <a href="https://wa.me/14436758888" target="_blank" rel="noreferrer" className="text-base cursor-pointer">+1-443-675-8888</a>
                            </div>
                            <div className='flex items-center space-x-2'>
                        ...
                        <div className='flex wrap items-center gap-4'>
                            ...
                            <a href="https://www.linkedin.com/company/ethian-global-tech-llc/" target="_blank" rel="noreferrer">
